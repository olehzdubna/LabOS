...
#define MCASP_IOCTL_ACTIVATE_TXRX           _IO(MCASP_IOCTL_MAGIC, 61)
#define MCASP_IOCTL_DEACTIVATE_TXRX         _IO(MCASP_IOCTL_MAGIC, 62)
#define MCASP_IOCTL_RUN_TEST                _IO(MCASP_IOCTL_MAGIC, 63)
